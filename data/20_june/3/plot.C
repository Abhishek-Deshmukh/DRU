void plot() {
  ...
  TH1F *h1 = new TH1F("h1", "Single Scatter cut", 400, 0, 4000);
  ...
  // plotting input
  TH1F *h2 = new TH1F("h2", "Input gamma", 200, 0,2000);
  ...
  cout << "10^9 particles simulates " << days << " days of simulation." << endl; // 0.416933 days
  cout << "so " << 1000000000/days << " particles will simulate a day" << endl; // 2.398E+9
}
