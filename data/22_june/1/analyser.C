void analyser() { // Getting Single Scatter Tree ready
  ...
  TTree* TotalTree = new TTree("TotalTree", "Tree contains all events");
  ...
  TotalTree->Branch("ParticleEnergy", &ParticleEnergy);
  TotalTree->Branch("CoinEnergyDep", &CoinEnergyDep);
  ...
  /* TH1F *h4 = new TH1F("totalEventHist", "No Cut (All Events)", 400, 0, 400); */
  /* h4->SetTitle("No Cut (All Events)"); */
  /* h4->GetXaxis()->SetTitle("Energy [KeV]"); */
  /* h4->GetYaxis()->SetTitle("Counts"); */
  /* TCanvas* c4 = new TCanvas("c4", "No Cut (ALl Events)", 1024, 768); */
  /* c4->cd(); */
  /* TotalTree->Draw("CoinEnergyDep*1000>>h4"); */
  /* c4->SetLogy(); */
  /* c4->SaveAs("no_cut.png"); */
