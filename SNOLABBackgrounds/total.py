...
plt.plot(energy_range[0:len(U_df)], U_df, label="U")
plt.plot(energy_range[0:len(TH_df)], TH_df, label="Th")
plt.plot(energy_range[0:len(K40_df)], K40_df, label="K40")
plt.plot(energy_range[0:len(total)], total, label="total")
plt.legend()
plt.grid()
